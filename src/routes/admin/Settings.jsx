...
// tab = top-level tab id, aSec = appearance sub-tab, sub = integrations sub-tab.
const SEARCH_INDEX = [
  { keys: ['الشعار', 'شعار', 'لوجو', 'logo'], tab: 'general', ar: 'الشعار والغلاف', en: 'Logo & cover' },
  { keys: ['الاسم', 'اسم المنشأة', 'name'], tab: 'general', ar: 'اسم المنشأة', en: 'Venue name' },
  { keys: ['الرابط', 'رابط', 'qr', 'link', 'slug'], tab: 'general', ar: 'رابط المنيو العام', en: 'Public menu link' },
  { keys: ['الثيم', 'ثيم', 'ثيمات', 'سكن', 'skin', 'theme'], tab: 'appearance', aSec: 'theme', ar: 'الثيمات', en: 'Themes' },
  { keys: ['الالوان', 'الألوان', 'لون', 'color'], tab: 'appearance', aSec: 'colors', ar: 'الألوان والنصوص', en: 'Colors & text' },
  { keys: ['الخط', 'خط', 'font'], tab: 'appearance', aSec: 'elements', ar: 'خط المنيو', en: 'Menu font' },
  { keys: ['البانر', 'بانر', 'banner'], tab: 'appearance', aSec: 'media', ar: 'البانر العلوي', en: 'Top banner' },
  { keys: ['الفيديو', 'فيديو', 'خلفية', 'video'], tab: 'appearance', aSec: 'media', ar: 'الخلفيات والفيديو', en: 'Backgrounds & video' },
  { keys: ['الاندماج', 'اندماج', 'تدرج', 'fade', 'melt'], tab: 'appearance', aSec: 'media', ar: 'اندماج البانر', en: 'Banner melt' },
  { keys: ['التخطيط', 'تخطيط', 'layout'], tab: 'appearance', aSec: 'elements', ar: 'التخطيط', en: 'Layout' },
  { keys: ['المميزة', 'مميز', 'featured'], tab: 'appearance', aSec: 'elements', ar: 'الأصناف المميزة', en: 'Featured items' },
  { keys: ['بطاقة العميل', 'welcome'], tab: 'appearance', aSec: 'elements', ar: 'بطاقة العميل', en: 'Customer card' },
  { keys: ['شريط التصنيفات', 'التصنيفات', 'تصنيف', 'category'], tab: 'appearance', aSec: 'elements', ar: 'شريط التصنيفات', en: 'Category bar' },
  { keys: ['وضع المنيو', 'عرض فقط', 'تصفح', 'browse'], tab: 'appearance', aSec: 'elements', ar: 'وضع المنيو', en: 'Menu mode' },
  { keys: ['نداء النادل', 'نادل', 'نداء', 'waiter'], tab: 'appearance', aSec: 'elements', ar: 'نداء النادل', en: 'Waiter call' },
  { keys: ['اجمالي السلة', 'إجمالي السلة', 'السلة', 'اجمالي', 'إجمالي', 'cart'], tab: 'appearance', aSec: 'elements', ar: 'إجمالي السلة', en: 'Cart total' },
  { keys: ['العضوية', 'عضوية', 'الولاء', 'ولاء', 'نقاط', 'بطاقة vip', 'vip', 'loyalty'], tab: 'integrations', sub: 'loyalty', ar: 'العضوية والولاء وبطاقة VIP', en: 'Loyalty & VIP' },
  { keys: ['الضريبة', 'ضريبة', 'زاتكا', 'vat', 'zatca', 'tax'], tab: 'integrations', sub: 'tax', ar: 'الضريبة (ZATCA)', en: 'VAT (ZATCA)' },
  { keys: ['الدفع الالكتروني', 'الدفع الإلكتروني', 'دفع', 'ميسر', 'moyasar', 'pay'], tab: 'integrations', sub: 'gateways', ar: 'الدفع الإلكتروني', en: 'Online payment' },
  { keys: ['الاشتراك', 'اشتراك', 'الباقة', 'باقة', 'subscription', 'plan'], tab: 'integrations', sub: 'gateways', ar: 'الاشتراك والباقة', en: 'Subscription' },
  { keys: ['الاكرامية', 'الإكرامية', 'اكرامية', 'إكرامية', 'tip'], tab: 'integrations', sub: 'gateways', ar: 'الإكرامية', en: 'Tips' },
  { keys: ['الموظفون', 'الموظفين', 'موظف', 'pin', 'رمز القفل'], tab: 'general', ar: 'الموظفون وأرقام PIN', en: 'Staff & PINs' },
  { keys: ['الطابعة', 'طابعة', 'الايصال', 'الإيصال', 'ايصال', 'إيصال', 'الفاتورة', 'فاتورة', 'receipt', 'print'], tab: 'receipt', ar: 'تصميم الفاتورة والإيصال', en: 'Receipt designer' },
  { keys: ['kds', 'المطبخ', 'مطبخ', 'شاشة المطبخ', 'kitchen'], tab: 'general', ar: 'شاشة المطبخ KDS', en: 'Kitchen display (KDS)' },
  { keys: ['الكاشير', 'كاشير', 'pos', 'cashier'], tab: 'appearance', aSec: 'staff', ar: 'مظهر الكاشير والمطبخ', en: 'Cashier & KDS look' },
  { keys: ['شاشة القفل', 'قفل', 'lock'], tab: 'appearance', aSec: 'pinlock', ar: 'شاشة القفل', en: 'Lock screen' },
  { keys: ['التوصيل', 'توصيل', 'delivery'], tab: 'integrations', sub: 'tax', ar: 'التوصيل', en: 'Delivery' },
  { keys: ['واتساب', 'اشعارات', 'إشعارات', 'whatsapp'], tab: 'integrations', sub: 'gateways', ar: 'إشعارات العميل (واتساب)', en: 'Customer notifications' },
]
...
export default function Settings() {
  ...
  // Settings search (jump-to-section) + last-successful-save stamp
  ...
  const [intSubTab, setIntSubTab] = useState('loyalty')
  ...
  // ----- settings search: match the static registry, jump straight to the section -----
  const searchMatches = useMemo(() => {
    const qq = q.trim().toLowerCase()
    if (!qq) return []
    return SEARCH_INDEX.filter((s) =>
      s.keys.some((k) => k.includes(qq) || qq.includes(k)) || s.ar.includes(qq) || s.en.toLowerCase().includes(qq)
    ).slice(0, 6)
  }, [q])
  const jumpTo = (m) => {
    setTab(m.tab)
    if (m.aSec) setASec(m.aSec)
    if (m.sub) setIntSubTab(m.sub)
  ...
  // Each tab is visible if the user holds ANY of its caps — so a scoped staffer
  // (e.g. appearance-only) sees just their tab instead of the whole settings.
  const TABS = [
    { id: 'general', icon: 'store', label: ar ? 'إعدادات المنشأة' : 'General Setup', caps: [CAP.MANAGE_SETTINGS] },
    { id: 'appearance', icon: 'sparkles', label: ar ? 'الاستوديو' : 'Design Studio', caps: [CAP.MANAGE_SETTINGS, CAP.MANAGE_APPEARANCE] },
    { id: 'receipt', icon: 'cashier', label: ar ? 'تصميم الفاتورة' : 'Receipt Designer', caps: [CAP.MANAGE_SETTINGS] },
    { id: 'integrations', icon: 'settings', label: ar ? 'التكاملات والسياسات' : 'Integrations & Policies', caps: [CAP.MANAGE_SETTINGS, CAP.MANAGE_INTEGRATIONS, CAP.MANAGE_LOYALTY] },
  ].filter((tb) => tb.caps.some((c) => can(c)))

  // If the current tab got filtered out (scoped staffer), snap to the first allowed one.
  useEffect(() => {
  ...
  return (
    <div className="page stack settings-page" style={{ gap: 'var(--sp-3)' }}>
      ...
      {/* tab bar */}
      <div className="row-between" style={{ gap: 12, borderBottom: '1px solid var(--border)', paddingBottom: 8, marginBottom: 8, flexWrap: 'wrap' }}>
        {/* padding + negative margin: the glass active chip scales/glows — without
            breathing room the scroll container CLIPS its edge (looked cut off) */}
        <div className="row" style={{ gap: 8, overflowX: 'auto', flex: 1, padding: 6, margin: -6 }}>
          {TABS.map((tb) => (
            <button key={tb.id} className={`chip ${tab === tb.id ? 'active' : ''}`} style={{ flex: 'none' }} onClick={() => setTab(tb.id)}><Icon name={tb.icon} size={15} /> {tb.label}</button>
          ))}
        </div>

        {/* settings search — type a keyword, pick a match, land on the right tab/section */}
        <div style={{ position: 'relative', flex: 'none', width: 210 }}>
          <Icon name="search" size={13} className="faint" style={{ position: 'absolute', insetInlineStart: 9, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
          <input
          ...
          />
          {searchOpen && q.trim() && searchMatches.length > 0 && (
            <div style={{ position: 'absolute', top: 'calc(100% + 4px)', insetInlineStart: 0, insetInlineEnd: 0, zIndex: 60, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, boxShadow: 'var(--sh-2, 0 10px 28px rgba(0,0,0,.16))', padding: 4, display: 'flex', flexDirection: 'column', gap: 2 }}>
              {searchMatches.map((m) => (
                <button
                  key={m.tab + (m.aSec || '') + (m.sub || '') + m.ar}
                  type="button"
                  className="row"
                  style={{ gap: 6, alignItems: 'center', padding: '7px 9px', border: 'none', background: 'none', cursor: 'pointer', textAlign: 'start', borderRadius: 8, fontSize: 'var(--fs-xs)', color: 'var(--text)', width: '100%' }}
                ...
                >
                  ...
                  <span className="xs faint" style={{ flex: 'none' }}>{TABS.find((tb) => tb.id === m.tab)?.label}</span>
                </button>
              ))}
            </div>
          )}
        ...
        {['appearance', 'menu', 'receipt'].includes(tab) && (
      ...
      {tab === 'general' && (
        <div className="stack" style={{ gap: 'var(--sp-4)' }}>
          ...
          {/* Design controls now live in ONE place — the Studio */}
          <button type="button" className="card card-pad row" style={{ gap: 10, alignItems: 'center', cursor: 'pointer', textAlign: 'start', width: '100%' }} onClick={() => setTab('appearance')}>
            <Icon name="sparkles" size={20} style={{ color: 'var(--brand)', flex: 'none' }} />
            <span className="grow">
              <strong style={{ display: 'block' }}>{ar ? 'الثيمات والقوالب انتقلت إلى الاستوديو' : 'Themes & templates moved to the Studio'}</strong>
              <span className="xs faint">{ar ? 'ثيم النظام، قوة الزجاج، المزج، القوالب، الثيمات، الكاشير والمطبخ وشاشة القفل — كلها في مكان واحد بمعاينة حية.' : 'System theme, glass intensity, mixing, templates, themes — one place with live preview.'}</span>
            </span>
      ...
      {/* ============ APPEARANCE (RE-DESIGNED & PREMIUM) ============ */}
      {/* Themes/skins/backgrounds are a Pro+ feature (plan-gated). */}
      {tab === 'appearance' && !planAllows(tenant, 'themes') && <UpgradeNotice feature="themes" />}
      {tab === 'appearance' && planAllows(tenant, 'themes') && (
            ...
            {planAllows(tenant, 'themes') ? (
              <>
                ...
                <div className="card card-pad stack" style={{ gap: 12 }}>
                  ...
                  <p className="xs faint" style={{ margin: 0 }}>{ar ? 'روابط الحسابات نفسها تُدخل من: الإعدادات ← عام ← وسائل التواصل.' : 'The links themselves are set in Settings → General → Social media.'}</p>
                </div>
                ...
                <div className="card card-pad stack" style={{ gap: 12 }}>
                  ...
                  <p className="xs faint" style={{ margin: 0 }}>{ar ? 'تفعيل القفل وأرقام الموظفين من: الإعدادات ← إعدادات المنشأة ← قفل PIN.' : 'Enable the lock + staff PINs in Settings → General.'}</p>
                </div>
                </div>
      ...
      {tab === 'integrations' && (
        <div className="stack" style={{ gap: 'var(--sp-3)' }}>
          ...
          <div className="segmented" style={{ width: 'fit-content' }}>
            <button className={intSubTab === 'loyalty' ? 'active' : ''} onClick={() => setIntSubTab('loyalty')}><Icon name="award" size={14} /> {ar ? 'الولاء والعضويات' : 'Loyalty & VIP'}</button>
            <button className={intSubTab === 'tax' ? 'active' : ''} onClick={() => setIntSubTab('tax')}><Icon name="cashier" size={14} /> {ar ? 'الضرائب والبلدية' : 'VAT & Municipal'}</button>
            <button className={intSubTab === 'gateways' ? 'active' : ''} onClick={() => setIntSubTab('gateways')}><Icon name="settings" size={14} /> {ar ? 'الربط الفني والتكاملات' : 'Technical Gateways'}</button>
          </div>

          <div style={{ height: 4 }} />

          {/* Sub Tab 1: Loyalty & VIP */}
          {intSubTab === 'loyalty' && (
          ...
          {/* Sub Tab 3: Technical Gateways & Custom Webhook */}
          {intSubTab === 'gateways' && (
            <div className="stack animate-fade-in" style={{ gap: 'var(--sp-4)' }}>
              <SubscriptionCard tenant={tenant} tenantId={tenantId} />
              <CustomDomainCard tenant={tenant} tenantId={tenantId} />
              ...
              <div className="card card-pad stack" style={{ gap: 12 }}>
                ...
                <div className="card card-pad stack" style={{ gap: 10, marginTop: 4 }}>
