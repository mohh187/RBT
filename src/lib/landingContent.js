...
export const LANDING_DEFAULTS = {
  ...
  hero: {
    ...
    subtitle: 'من المنيو والطلب بالباركود، إلى الكاشير والمطبخ اللحظي، إلى المخزون والحملات والمساعد الذكي. منشأتك كلها في نظام عربي واحد، وبدون أي عمولة على طلباتك.',
  ...
  features: {
    ...
    items: [
      { icon: 'qr', title: 'منيو QR وطلب إلكتروني', desc: 'يمسح الضيف الرمز فيتصفح ويطلب، وطلب الطاولة يصل الكاشير والمطبخ لحظياً.' },
  ...
  pricing: {
    ...
    note: 'الأسعار بالريال السعودي ولا تشمل ضريبة القيمة المضافة. الأرقام المعروضة تأتي مباشرةً من جدول الأسعار الذي يفوتر منه الخادم، ولا جدول ثانٍ في الصفحة.',
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'هل أستطيع تغيير باقتي لاحقاً؟', a: 'نعم. ترقَّ أو اخفض باقتك في أي وقت من لوحة التحكم، وتُفتح المزايا الجديدة فوراً.' },
      { q: 'هل تُفرض عمولة على الطلبات؟', a: 'أبداً. اشتراك شهري ثابت فقط، وكل ريال من مبيعاتك يبقى لك مهما كبر حجم طلباتك.' },
    ],
  },
