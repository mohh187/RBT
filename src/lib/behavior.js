...
export const AI_PLANNER_GUARD_AR = [
  ...
  'لا تقارن بمتوسطات السوق أو معايير خارجية، فلا توجد لديك بيانات عنها.',
  ...
  'الارتباط بين سلوك وآخر (مثل اللعب أو العرض ثلاثي الأبعاد) لا يعني السببية، فاذكر ذلك عند المقارنة.',
...
function cohortPair(list, key, labelAr, predicate) {
  ...
  return {
    ...
    note: 'ارتباط لا سببية، فقد يكون الفارق بسبب نوع الضيف لا بسبب الميزة',
  }
}
