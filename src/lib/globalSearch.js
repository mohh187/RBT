...
export const PAGE_INDEX = [
  ...
  { id: 'print-studio', ar: 'استوديو التصميم الحر', en: 'Print design studio', to: '/admin/print-studio', icon: 'penLine', cap: CAP.MANAGE_MENU,
    keywords: ['استوديو تصميم', 'تصميم حر', 'بوستر', 'مطبوعات', 'اشكال', 'عناصر', 'كانفا', 'ايقونات', 'خطوط', 'تأثيرات', 'شكل الباركود', 'design studio', 'poster', 'canvas', 'icons', 'fonts'] },
  { id: 'table-stickers', ar: 'ملصقات استاند الطاولة', en: 'Table stand stickers', to: '/admin/table-stickers', icon: 'qr', cap: CAP.MANAGE_STICKERS,
    keywords: ['ملصق', 'ملصقات', 'استيكر', 'استاند', 'مناديل', 'رمز الطاولة', 'باركود الطاولة', 'sticker', 'stand', 'table qr'] },
  { id: 'ads', ar: 'استوديو الإعلانات', en: 'Ads studio', to: '/admin/ads', icon: 'image', cap: CAP.MANAGE_CAMPAIGNS,
    keywords: ['اعلان', 'اعلانات', 'بوستر', 'نافذة', 'منبثقة', 'ترحيب', 'بانر', 'popup', 'ads', 'banner', 'promo'] },
  { id: 'growth', ar: 'فرص النمو', en: 'Growth', to: '/admin/growth', icon: 'trending', cap: CAP.VIEW_REPORTS,
    keywords: ['نمو', 'فرص', 'يطلب معه', 'سلة متروكة', 'ساعات هادئة', 'صحة المنيو', 'اعادة الطلب', 'growth', 'upsell', 'abandoned'] },
