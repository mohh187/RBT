...
export function speechErrorText(code, lang = 'ar') {
  const ar = {
    denied: 'إذن الميكروفون مرفوض. فعّله لهذا الموقع من إعدادات المتصفح ثم أعد المحاولة.',
    nomatch: 'ما وصل صوت واضح. قرّب الجهاز وحاول مرة أخرى.',
    network: 'التعرف على الصوت يحتاج اتصالاً بالإنترنت. تحقق من الشبكة وأعد المحاولة.',
    unsupported: 'التعرف على الصوت غير مدعوم في هذا المتصفح. جرّبه من Chrome أو Safari.',
