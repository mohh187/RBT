...
export const GAMES = [
  ...
  // min/maxPlayers drive the seat count the lobby waits for.
  {
    ...
    ar: 'الوِست',
    en: 'Wist',
    desc: 'وِست بالمزايدة والشراكات، أربعة لاعبين وفريقين وثلاث عشرة أكلة.',
  ...
  },
  {
    ...
    ar: 'الحريق',
    en: 'Hareeg',
    desc: 'حريق 14 بشدّتين وجوكرات. افتتح بخمسين ونقطة، وارمِ بلا غطاء. من بلغ 31 احترق وخرج، وآخر من يبقى يفوز.',
  ...
  },
  {
    ...
    ar: 'الشطرنج',
    en: 'Chess',
    desc: 'شطرنج كامل القواعد، فيه التبييت والأخذ بالمرور والترقية، وحركة غير قانونية مستحيلة.',
