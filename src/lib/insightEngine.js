...
export const ARCHETYPES = [
  {
    ...
    predictions: [
      ...
      'تغادر التجمعات الكبيرة قبل نهايتها بقليل، لا ضجراً بل حاجةً لاستعادة هدوئك.',
    ],
  },
  {
    id: 'ritualMaker',
    ...
    strengths: [
      'يمكن الاعتماد عليك، فما تقوله يحدث في وقته.',
...
export const DECISION_STYLES = [
  ...
  },
  {
    ...
    portrait: 'تفكر بصوت عالٍ ومع الناس. الاستشارة عندك ليست ضعفاً بل طريقة تفكير، فالكلام يوضّح لك ما لم يكن واضحاً في رأسك.',
