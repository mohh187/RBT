...
const T = {
  ar: {
    ...
    intro: 'توصيات محسوبة من طلبات منشأتك الفعلية، وكل رقم هنا مأخوذ من بياناتك لا من تقدير.',
    ...
    aiOff: 'المساعد الذكي غير مفعّل، والتوصيات أعلاه تعمل بدونه.',
    aiErr: 'تعذّر التحليل الذكي الآن، جرّب بعد قليل. التوصيات المحسوبة أعلاه لا تزال صالحة.',
  ...
  en: {
    ...
    intro: 'Recommendations computed from your venue\'s real orders, and every figure here comes from your data, not an estimate.',
    ...
    aiOff: 'AI is switched off, and the recommendations above work without it.',
    aiErr: 'AI analysis is unavailable right now, so try again shortly. The computed recommendations above still stand.',
