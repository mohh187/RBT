...
const TXT = {
  ar: {
    title: 'ذوقك يحكي عنك',
    how: (items) => `فصلان: أولاً اختيارات بين صنفين من ${items} الحقيقية هنا، ثم بين ميلين في طبعك. لا توجد إجابة صحيحة — نقرأ الميل لا المعرفة.`,
    howThin: 'القائمة لا تكفي لفصل الذوق، فنقرأ من فصل الميول وحده — بصراحة.',
    ch1: 'من الطاولة', ch2: 'من طبعك',
    chLine: (n, total, name) => `الفصل ${arNum(n)} من ${arNum(total)} · ${name}`,
    preview1: 'الفصل الأول: صنفان من القائمة.',
    preview2: 'الفصل الثاني: ميلان في طبعك.',
    thinChip: 'القائمة قصيرة — فصل واحد',
    ...
    beatK: 'اكتمل فصل الطاولة', beatT: 'من طبعك', beatS: 'الآن نترك القائمة ونقرأ ميولك مباشرة — هنا تكتمل الصورة.', beatBtn: 'تابع',
    ...
    thinTitle: 'لا يمكن قراءة الذوق من القائمة',
  ...
  en: {
    ...
    how: () => 'Two chapters: first either/or picks from this venue\'s real menu, then between two leanings in you. No right answer — we read leaning, not knowledge.',
    howThin: 'The menu is too thin for a taste chapter, so we read from the preference chapter alone — honestly.',
    ...
    beatK: 'The table chapter is done', beatT: 'From your nature', beatS: 'Now we leave the menu and read your leanings directly — this completes the picture.', beatBtn: 'Continue',
