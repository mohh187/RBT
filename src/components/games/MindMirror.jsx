...
const CH2_BANK = [
  ...
  },
  {
    ...
    options: [
      { key: 'a', label: 'أقف وأرتجل — هذه الطاقة تعجبني.', loadings: { extraversion: 0.8, stability: 0.4, novelty: 0.25 } },
...
const TXT = {
  ar: {
    ...
    beatK: 'اكتمل الفصل الأول', beatT: 'تحت الضغط', beatS: 'المواقف تصبح أصعب الآن — هنا تظهر ملامحك الحقيقية.', beatBtn: 'تابع',
  ...
  en: {
    ...
    beatK: 'Chapter one complete', beatT: 'Under pressure', beatS: 'The situations get harder now — this is where your real shape shows.', beatBtn: 'Continue',
