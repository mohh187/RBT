...
const TXT = {
  ar: {
    title: 'كيف تقرر؟',
    how: 'فصلان من المواقف. اختر ما تفعله فعلاً، فلا يوجد أسلوب قرار «صحيح»؛ لكل أسلوب موضع يتفوّق فيه وموضع يكلّفك.',
    ...
    beatK: 'اكتمل الفصل الأول', beatT: 'القرارات الكبرى', beatS: 'الآن ترتفع الرهانات، والقرارات التي لا رجعة فيها تكشف أسلوبك الحقيقي.', beatBtn: 'تابع',
  ...
  en: {
    ...
    beatK: 'Chapter one complete', beatT: 'The big decisions', beatS: 'The stakes rise now, and irreversible calls reveal your real style.', beatBtn: 'Continue',
