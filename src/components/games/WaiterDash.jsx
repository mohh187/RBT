...
const TXT = {
  ...
  en: {
    title: 'Waiter Dash',
    how: 'Swipe up or down to change lane, tap to jump what can be cleared. Collect cups, dodge the rest — every hit rocks the tray.',
    start: 'Start running',
    again: 'Play again',
    ...
    swipe: 'Swipe up/down',
    tap: 'Tap to jump',
    hintTable: 'Tables cannot be jumped — change lane to dodge',
    hintWaiter: 'A waiter is closing fast — clear the lane',
    hintCart: 'A wide cart blocks two lanes — take the open one',
    goldCup: 'Golden cup',
  },
}
