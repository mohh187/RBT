...
const ROWS_AR = [
  ...
  ['layers', 'شرائح تسويقية محسوبة بقواعد ثابتة (المنافسون، ومن توقّف في المنتصف، ومن أنهى الاختبار ولم يطلب)، مع قائمة الأرقام التي يمكن مراسلتها فعلاً.'],
    ...
    <div className="gp-card">
      <div className="gp-empty">
        ...
        <p>
          {ar
            ? (hasGames
              ? `لم يلعب أي ضيف داخل الفترة المختارة${periodLabel ? ` (${periodLabel})` : ''}. الصفحة تعمل، لكن لا يوجد ما تعرضه بعد. جرّب توسيع الفترة أولاً.`
