...
const T = {
  ar: {
    ...
    thanksLine: 'سنة كاملة وأنت معنا، ونراك في القادمة.',
    share: 'شارك قصتك',
    copied: 'تم نسخ الملخص',
    copyFail: 'ما تمت المشاركة، انسخ النص وأرسله بنفسك',
    thinTitle: 'لسه في البداية',
    thinLine: 'زياراتك القادمة تبني قصتك، ونحتفظ لك بكل زيارة.',
    close: 'إغلاق',
    dishes: 'صنفاً جرّبته',
    biggest: 'أكبر طلب',
  },
  en: {
    ...
    thanksLine: 'A whole year together, and we will see you in the next one.',
    share: 'Share your story',
    copied: 'Summary copied',
    copyFail: 'Sharing did not work, copy the text and send it yourself',
    thinTitle: 'Just getting started',
    thinLine: 'Your next visits will build your story, and every one of them counts.',
    close: 'Close',
    dishes: 'dishes tried',
