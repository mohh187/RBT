...
const PAGES = [
  ...
  { to: '/platform/documents', title: 'المستندات', kw: 'quote quotation invoice tax document عرض سعر عروض اسعار فاتورة فواتير ضريبية مستندات', icon: 'file' },
  { to: '/platform/finance', title: 'المالية', kw: 'finance pnl profit margin vat aging accounting مالية ارباح هامش ضريبة اعمار محاسبة قائمة الدخل', icon: 'chartBar' },
  ...
  { to: '/platform/health', title: 'الصحة والتنبيهات', kw: 'health alerts vendor status monitoring صحة تنبيهات مزودين حالة مراقبة اعطال', icon: 'zap' },
